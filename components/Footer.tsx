...
export function Footer() {
  ...
  return (
    <footer className="border-t border-line bg-cream px-6 py-14 lg:px-16">
      <div className="mx-auto grid max-w-6xl gap-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-charcoal-muted">
            {services.slice(0, 5).map((service) => (
              <li key={service.slug}>
                <Link href={`/servicii/${service.slug}`} className="hover:text-bronze-deep">
                  {service.shortTitle}
                </Link>
              </li>
            ))}
            <li>
              <Link href="/servicii" className="text-bronze-deep hover:underline">
                Toate domeniile →
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-charcoal-muted">
            <li>
              <Link href="/despre-noi" className="hover:text-bronze-deep">
                Despre noi
              </Link>
            </li>
            <li>
              <Link href="/contact" className="hover:text-bronze-deep">
                Contact
              </Link>
            </li>
            <li>
              <Link href="/politica-de-confidentialitate" className="hover:text-bronze-deep">
                Politica de confidențialitate
              </Link>
            </li>
            <li>
              <Link href="/termeni-si-conditii" className="hover:text-bronze-deep">
                Termeni și condiții
              </Link>
            </li>
          </ul>
